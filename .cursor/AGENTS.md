...
2. Match to agent(s) whose Primary use covers the request.
3. Use matched agent(s); if none match, respond as Main.

## Definition of "needed" agent
An agent is needed when the request type falls under its Primary use (see Quick reference).
